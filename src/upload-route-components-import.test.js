...
test("App imports extracted upload route mobile primitives", () => {
  ...
  for (const name of ["AuthenticatedUploadPreview", "UploadCreateCard", "UploadDetailPanel", "UploadListCard", "UploadMobileAccordionCard", "UploadMobileFieldGroup", "UploadsCommandRailPolished", "UploadsFieldOperatorPanel", "UploadsMobileFocusPanel", "UploadsProofWorkbench", "UploadsTablePolished"]) {
