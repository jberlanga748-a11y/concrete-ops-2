...
test("desktop Sidebar is extracted from App and keeps filtered navigation inputs", () => {
  ...
  assert.match(appSource, /<Sidebar active=\{active\} setActive=\{setActive\} counts=\{counts\} navGroups=\{visibleNavGroups\} logoInitials=\{workspaceLogoInitials\} brandAssets=\{APEX_BRAND_ASSETS\} appName=\{APP_NAME\} \/>/);
