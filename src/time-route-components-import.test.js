...
test("App imports extracted time summary cards", () => {
  ...
  for (const name of ["ActiveTimeCard", "RecentTimeEntriesCard", "TimeEntryCard", "TimeKpiCardPolished", "TimeMobileAccordionCard", "TimeMobileFieldGroup", "TimeStatusBadge", "TimeSummaryMetricsPolished", "WeekSummaryCard"]) {
