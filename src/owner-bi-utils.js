...
export function deriveOwnerBusinessIntelligenceState({
  ...
  const closeoutBillingReview = buildJobCloseoutBillingReviewPacket({
    ...
    jobCostEntries: activeRecords(jobCostEntries),
  ...
  const scorecards = [
    ...
    scorecard({
      ...
      title: "Job costing review prep",
      value: formatMoney(closeoutMetrics.jobCostingReviewDelta || closeoutMetrics.reviewTotal || 0),
      detail: `${Number(closeoutMetrics.jobCostingReadyForManualReview || 0)} job-costing review${Number(closeoutMetrics.jobCostingReadyForManualReview || 0) === 1 ? "" : "s"} ready, ${formatMoney(closeoutMetrics.jobCostingActualCostTotal || 0)} reviewed actual cost input${Number(closeoutMetrics.jobCostingActualCostTotal || 0) === 1 ? "" : "s"}, and ${Number(closeoutMetrics.jobCostingInputWarnings || closeoutMetrics.profitLossInputWarnings || 0)} warning${Number(closeoutMetrics.jobCostingInputWarnings || closeoutMetrics.profitLossInputWarnings || 0) === 1 ? "" : "s"}. Apex prepares context only.`,
      tone: closeoutMetrics.jobCostingInputWarnings || closeoutMetrics.profitLossInputWarnings ? "amber" : "green",
      moduleId: "jobs",
      actionLabel: "Review closeout",
    }),
    scorecard({
  ...
  return {
    ...
    metrics: {
      ...
      jobCostingReadyForManualReview: Number(closeoutMetrics.jobCostingReadyForManualReview || 0),
      jobCostingActualCostTotal: money(closeoutMetrics.jobCostingActualCostTotal || 0),
      jobCostingReviewDelta: money(closeoutMetrics.jobCostingReviewDelta || 0),
      jobCostingInputWarnings: Number(closeoutMetrics.jobCostingInputWarnings || 0),
