...
test("estimate PDF attachment includes customer-facing proposal details only", async () => {
  ...
  assert.match(decodedText, /GC \/ Prime Proposal/);
  assert.match(decodedText, /GC PROPOSAL PACKET/);
  assert.match(decodedText, /CONCRETE BID PACKAGE/);
  ...
  assert.match(decodedText, /Confirm addenda, inclusions, exclusions, access, and schedule assumptions before award/);
  ...
  assert.match(decodedText, /CONCRETE SPECIFICATIONS/);
...
test("residential proposal PDF defaults to homeowner-ready cover language", async () => {
  ...
  assert.match(decodedText, /RESIDENTIAL CONCRETE PROPOSAL/);
  assert.match(decodedText, /Ready for homeowner review/);
...
test("polished estimate sheet PDF uses estimate language instead of proposal cover language", async () => {
  ...
  assert.match(decodedText, /CONCRETE ESTIMA/);
  ...
  assert.match(decodedText, /Yard Concrete Co\. estimate sheet\./);
