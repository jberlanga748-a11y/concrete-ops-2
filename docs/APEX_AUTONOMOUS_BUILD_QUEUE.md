...
| 2026-05-21 | P3 | Estimate sent history card architecture extraction | Done; sent proposal history card moved into the estimate route component module with build, role, estimate, route, and browser audits passing | pending |
