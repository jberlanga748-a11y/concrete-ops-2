...
| 2026-05-21 | P3 | Shared input primitive architecture extraction | Done; InputField and TextAreaField moved into the shared shell module with build, role, estimate, route, and browser audits passing | pending |
