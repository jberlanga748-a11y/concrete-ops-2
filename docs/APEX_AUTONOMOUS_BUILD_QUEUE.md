...
| 2026-05-21 | P2 | Demo/pilot monitoring baseline decision | Done; GitHub Actions plus GitHub issues documented as the current demo/pilot monitoring baseline with production log drains and paid providers still blocked | `pending` |
