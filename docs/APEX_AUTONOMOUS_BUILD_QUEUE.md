...
| 2026-05-21 | P3 | Estimate proposal sections editor architecture extraction | Done; proposal sections and option-section composition moved into the estimate route component module with build, role, estimate, route, and browser audits passing | pending |
