...
| 2026-05-21 | P2 | Fencing walkthrough preflight refresh after readiness baseline | Done; Fly demo ready, hosted skip-auth smoke, admin desktop/tablet audits, employee phone audit, and roles passed | `pending` |
