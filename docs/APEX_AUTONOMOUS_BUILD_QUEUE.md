...
| 2026-05-21 | P3 | Leads table architecture extraction | Done; lead table, score/missing-info badges, and lead display helpers moved into a lead route component module with build, role, lead, route, and browser audits passing | pending |
