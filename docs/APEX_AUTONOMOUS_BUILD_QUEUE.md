...
| --- | --- | --- | --- | --- |
| 2026-05-22 | P3 | Field next job card extraction | Done; next assigned job mobile card moved into `src/field-route-components.jsx` with import-boundary coverage, field/role/build checks, and browser audits passing for employee mobile field routes | This commit |
