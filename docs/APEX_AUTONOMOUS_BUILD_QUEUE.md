...
| 2026-05-21 | P2 | Opportunity Scout safety verification refresh | Done; 69 local tests passed for review-first intake, redaction, dedupe, approval gates, package/role blocking, and no auto-contact/bid/credential behavior | `pending` |
