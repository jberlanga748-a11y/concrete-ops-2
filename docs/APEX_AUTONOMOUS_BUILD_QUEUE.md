...
| --- | --- | --- | --- | --- |
| 2026-05-22 | P3 | PWA installability hardening | Done; manifest now has stable app identity, dark shell install theme, tablet-safe orientation, role-safe field shortcuts, and tests that keep private-data/offline caching out of the pilot PWA path | Pending |
