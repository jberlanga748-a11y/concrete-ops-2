...
| --- | --- | --- | --- | --- |
| 2026-05-22 | P3 | Contact history route component extraction | Done; shared contact history UI moved out of `App.jsx` into `src/contact-history-route-components.jsx` with import-boundary coverage, customer/lead/role/build checks, and browser audits passing for leads, customers, and communications | This commit |
