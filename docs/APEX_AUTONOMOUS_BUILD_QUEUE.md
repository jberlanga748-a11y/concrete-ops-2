...
| 2026-05-21 | P2 | Fly demo Estimate PDF header deploy | Done; backup-first demo deploy to `concrete-ops-demo` v130 plus `/api/ready` and hosted skip-auth smoke passed | `pending` |
