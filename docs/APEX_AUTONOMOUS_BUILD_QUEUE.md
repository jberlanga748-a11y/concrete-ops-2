...
| 2026-05-21 | P2 | Launch gate snapshot refresh after readiness baseline | Done; guided demo and demo/pilot monitoring baseline are GO, while customer pilot, production auth smoke, and wider paid launch remain NO-GO | `pending` |
