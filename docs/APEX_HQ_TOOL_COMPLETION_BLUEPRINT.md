...
| Takeoff Studio | Plan/PDF measurement and quantity backup for estimates. | Phase 1 built; Phase 2 built; Phase 3 built; Phase 4 built; Phase 5 advanced power next | Owner/admin or estimator can measure plans, review quantities, connect quantity backup to blank-priced estimate line drafts, choose customer-safe proposal proof, prepare GC/internal takeoff summaries, use review-first assistant suggestions, and carry explicitly approved field-safe quantity context into foreman handoff without exposing office data to field users. | Apex Takeoff Studio Phases 1-5 | Provider-backed AI plan assistance, provider/file parsing upgrades, and advanced exports later. | Freeze each takeoff phase after role-safe validation; do not rebuild Estimate Studio. |
