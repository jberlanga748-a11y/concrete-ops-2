...
| Takeoff Studio | Plan/PDF measurement and quantity backup for estimates. | Phase 1 built; Phase 2 integration/proof checkpoints in progress | Owner/admin or estimator can measure plans, review quantities, connect quantity backup to blank-priced estimate line drafts, choose customer-safe proposal proof, prepare GC/internal takeoff summaries, and later use review-first AI assistance without exposing office data to field users. | Apex Takeoff Studio Phases 1-5 | AI plan assistance, provider/file parsing upgrades, and advanced exports later. | Freeze each takeoff phase after role-safe validation; do not rebuild Estimate Studio. |
