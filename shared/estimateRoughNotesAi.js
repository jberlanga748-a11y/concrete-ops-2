...
export function sanitizeEstimateRoughNotesResponse(payload = {}) {
  return {
    ...
    customerName: text(payload.customerName, 220),
    contactName: text(payload.contactName, 180),
    customerEmail: text(payload.customerEmail, 180),
    projectName: text(payload.projectName, 220),
    jobLocation: text(payload.jobLocation, 260),
