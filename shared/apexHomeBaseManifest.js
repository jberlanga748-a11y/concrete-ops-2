...
export function buildApexHomeBaseManifest({
  ...
  return Object.freeze({
    ...
    runtime: Object.freeze({
      ...
      trustedDesktopEntry: Object.freeze({
        enabled: true,
        scope: "loopback-only-existing-operator-session",
    ...
    selfEditLoop: Object.freeze({
      ...
      defaultValidationCommands: Object.freeze([
        "node --test --test-concurrency=1 scripts\\apex-local-operator-runtime.test.mjs scripts\\apex-desktop-app.test.mjs shared\\apexHomeBaseManifest.test.js shared\\apexDesktopTrustedEntry.test.js",
